...
def create_base(file_path, kb_name):
    ...
    try:
        ...
        print(f'docs: {docs}')
        documents = []
        persist_directory = os.path.join('/root/autodl-tmp/knowledge_path/', kb_name)
           
        # 向量化
        embeddings = HuggingFaceEmbeddings(model_name='/root/autodl-tmp/text2vec-base-multilingual')
